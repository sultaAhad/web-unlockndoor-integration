...
function LikeMatchMatched() {
	...
	// Refetch when page/filter changes — DO NOT clear matchedProfiles here
	useEffect(() => {
		// do not clear matchedProfiles to avoid hiding pagination/cards
		// show spinner via isFetching/isLoading from RTK Query instead
		refetch();
		...
		<>
			...
			<section className="videos_sec">
				<div className="container">
					...
					{/* Always render pagination based on lastPage (defensive) */}
							...
							<div className="col-lg-2 mx-auto">
								<div className="btn-wrapper">
									<Pagination
										...
										lastPage={lastPage}
										onPageChange={(page) => {
											// defensive: ensure page is valid number
