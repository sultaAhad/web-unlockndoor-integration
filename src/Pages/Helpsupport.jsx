						...
						<div className="accordion" id="faqAccordion">
							...
							<div className="accordion-item">
								<h2 className="accordion-header" id="headingOne">
									<button
										className="accordion-button collapsed gradient-text"
										type="button"
								...
								>
									<div className="accordion-body" style={{ color: "#fff" }}>
										UnlockNthedoor is built to be simple, but questions can
										still come up. This section offers support for everything
										from login issues to account questions and reporting tools.
									</div>
								</div>
							</div>
							...
							<div className="accordion-item">
								...
								>
									<div className="accordion-body" style={{ color: "#fff" }}>
										...
										<ul>
											<li>
												Forgotten your password? Use the password reset link.
											</li>
											<li>
												Still can’t log in? Contact support with your registered
												email.
											</li>
										</ul>
										<h5>Profile Management</h5>
										<ul>
											<li>
												To update details like age, location, or interests,
												visit your profile settings.
											</li>
											<li>
												Is the profile photo not showing? Make sure it meets the
												upload requirements (JPEG or PNG, clear image, no
												filters).
											</li>
										</ul>
									</div>
							...
							<div className="accordion-item">
								...
								>
									<div className="accordion-body" style={{ color: "#fff" }}>
										...
										<ul>
											<li>
												Premium accounts may be required to start certain
												conversations.
											</li>
											<li>
												If you were blocked, that user won’t receive your
												messages.
											</li>
										</ul>
										<h5>Safety First</h5>
										<ul>
											<li>
												Use the Report feature to flag suspicious behavior.
											</li>
											<li>
												Block users who make you uncomfortable—they won’t be
												able to contact you again.
											</li>
											<li>
												Never send money or share personal banking info with
												anyone you’ve just met online.
											</li>
										</ul>
									</div>
								</div>
							...
							<div className="accordion-item">
								...
								>
									<div className="accordion-body" style={{ color: "#fff" }}>
										...
										<ul>
											<li>
												You can upgrade, downgrade, or cancel through the
												Billing section.
											</li>
											<li>
												Cancel before your renewal date to avoid being charged
												for the next cycle.
											</li>
										</ul>
										<h5>Payment Issues</h5>
										<ul>
											<li>
												Ensure your payment method is active and details are
												correct.
											</li>
											<li>Contact your bank if the payment still fails.</li>
										</ul>
							...
							<div className="accordion-item">
								...
								>
									<div className="accordion-body" style={{ color: "#fff" }}>
										...
										<ul>
											<li>
												Try clearing your browser cache or updating the app.
											</li>
											<li>Switch devices to isolate the issue.</li>
										</ul>
										<h5>Images Not Uploading?</h5>
										<ul>
											<li>
												Make sure the image is under the size limit and in the
												accepted format.
											</li>
										</ul>
									</div>
								...
								>
									<div className="accordion-body" style={{ color: "#fff" }}>
										<p>
											...
											<br />
											For urgent issues such as safety concerns or payment
											disputes, mark your message as{" "}
											<em className="gradient-text">“High Priority”</em> in the
											subject line.
										</p>
									</div>
								</div>
