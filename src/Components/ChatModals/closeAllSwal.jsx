// ✅ Global Swal manager
let activeSwalInstances = [];

export const closeAllSwal = () => {
	activeSwalInstances.forEach((instance) => {
...
// Header.js mein use karein
videoChannel.bind("call.action", (data) => {
	// ✅ Pehle existing Swals close karein
	closeAllSwal();
	...
	activeSwalInstances.push(swal);

	swal.then((result) => {
		// Remove from array when closed
		activeSwalInstances = activeSwalInstances.filter((inst) => inst !== swal);
		// ... rest of your code
	});
});
